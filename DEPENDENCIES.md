...
| `serde` | 1 | `app` | Serialisation derive macros for cache structs | MIT / Apache-2.0 |
| `serde_json` | 1 | `app` | JSON encoding/decoding of the channel cache file | MIT / Apache-2.0 |
